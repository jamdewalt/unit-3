...
(function () {
    ...
    var yScale = d3.scaleLinear().range([463, 0]).domain([0, 1]); //% scale
    ...
    function setEnumerationUnits(arizonaRegions, map, path, colorScale) {
        ...
        var regions = map
            ...
            .attr("class", function (d) {
                return "regions d" + d.properties.geoid;
            })
            .attr("d", path)
    ...
    function updateChart(bars, n, colorScale) {
        ...
        var chartTitle = d3
            .select(".chartTitle")
            .text("Percentage of " + expressed + " out of All County Data");
    }
